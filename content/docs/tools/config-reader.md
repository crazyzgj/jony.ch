...
<script>
// Huawei sample configuration including user's specific Eth-Trunk, WLAN AC & Profile examples
...
vap-profile name coopguest
 ...
 sac-profile default
#
# --- Example 4: WLAN AC Section Profiles ---
#
wlan ac
...
#
# --- Example 5: VPN Instance Creation & Reference Tracking ---
#
...
function getDefinitionBlockText(model, startLineNum) {
  ...
  // If current line is indented (e.g. child under "wlan ac"), find top parent section header
  if (currentIndent > 0) {
